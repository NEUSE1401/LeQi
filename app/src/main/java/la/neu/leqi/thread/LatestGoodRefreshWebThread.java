...
public class LatestGoodRefreshWebThread extends AsyncTask<Void,Void,ArrayList<Good>> {
    private String BASE_URL;
    private ShopGoodItemAdapter shopGoodItemAdapter;
    private Context context;

    public LatestGoodRefreshWebThread(String base_url, ShopGoodItemAdapter paramMyAdapter, Context paramContext) {
        BASE_URL = base_url;
