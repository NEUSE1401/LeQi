...
public class ShareListRefreshWebThread extends AsyncTask<Void, Void, ArrayList<Share>> {
    private String BASE_URL;
    private PullToRefreshBase<RecyclerView> pullToRefreshView;
    private ShareListAdapter shareListAdapter;
    private Context context;

    public ShareListRefreshWebThread(String base_url, PullToRefreshBase<RecyclerView> paramPullToRefreshListView, ShareListAdapter paramMyAdapter, Context paramContext) {
        BASE_URL = base_url;
